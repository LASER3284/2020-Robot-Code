...
private:
	...
	vector<Translation2d> m_InteriorWaypoints
	{
		Translation2d
		{
			6.0_ft,					// X of point 2 on field in feet.
			7.5_ft					// Y of point 2 on field in feet.
		},
		Translation2d
		{
			11.0_ft,				// X of point 3 on field in feet.
			2.5_ft					// Y of point 3 on field in feet.
		},
		// Translation2d
		// {
		// 	6.0_ft,				// X of point 3 on field in feet.
		// 	1.0_ft					// Y of point 3 on field in feet.
		// },
	};
	...
	{
		3_fps,					// Robot max velocity I think. (Or whatever max velocity or acceleration you wish to put.)
